...
import com.example.intellicateradmin.adapter.DeliveryAdapter
import com.example.intellicateradmin.adapter.PendingOrderAdapter
import com.example.intellicateradmin.databinding.ActivityPendingOrderBinding
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    private fun addDataToListForRecyclerView() {
        for (orderItem in listOfOrderItem) {
            ...
            orderItem.tokenNum?.let { listOfName.add(it) }
    ...
    private fun setAdapter() {
        ...
        val adapter =
            PendingOrderAdapter(this, listOfName, listOfTotalPrice, this)
